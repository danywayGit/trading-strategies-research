# SWING4 — Stage 3 Summary (home TF: 4H)

**Date:** 2026-06-04
**Combos processed:** 101
**DOW improvement rate:** 66 / 101 (65.3%) — combos where a DOW mask beat ALL by ≥ 0.10 Sharpe with ≥ 20 trades
...
| MON+FRI | 3 | 3.0% |
| TUE+SUN | 3 | 3.0% |
| TUE+WED+THU+FRI+SAT+SUN | 3 | 3.0% |
| TUE+WED+THU+SUN | 2 | 2.0% |
| MON+TUE+THU+SUN | 2 | 2.0% |
| MON+TUE+WED+FRI | 2 | 2.0% |
| WED+THU+SUN | 2 | 2.0% |
| TUE+WED+THU+FRI | 2 | 2.0% |
| MON+TUE+FRI+SAT+SUN | 2 | 2.0% |
| MON+THU+FRI+SUN | 2 | 2.0% |
| THU+FRI | 2 | 2.0% |
| MON+TUE+WED+SAT+SUN | 2 | 2.0% |
| TUE+WED+FRI | 2 | 2.0% |
| FRI+SAT+SUN | 2 | 2.0% |
| MON+WED+THU+FRI+SUN | 2 | 2.0% |
| WED+THU+FRI+SAT+SUN | 1 | 1.0% |
| FRI | 1 | 1.0% |
| MON+WED+FRI | 1 | 1.0% |
| WED+FRI+SAT | 1 | 1.0% |
| WED | 1 | 1.0% |
...
| THU+SUN | 1 | 1.0% |
| TUE+THU | 1 | 1.0% |
| THU+FRI+SAT+SUN | 1 | 1.0% |
| MON+SAT+SUN | 1 | 1.0% |
| MON+SAT | 1 | 1.0% |
| TUE+FRI+SAT | 1 | 1.0% |
| TUE+WED+THU+SAT+SUN | 1 | 1.0% |
...
| BCHUSDT | 12h | long | fixed_pct | ALL | 0.36817693122649053 | 0.3682 | 9 | ➖ |
| BCHUSDT | 12h | long | fixed_signal | ALL | 0.36817693122649053 | 0.3682 | 9 | ➖ |
| UNIUSDT | 12h | long | embedded | ALL | 0.22766610738389928 | 0.2277 | 12 | ➖ |

**Stage 3 DOW improvement rate: 66 / 101**
