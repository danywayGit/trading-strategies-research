#!/usr/bin/env python3
"""
VP1 Stage 1 optimization across all available symbols.
Home TF: 1H. Runs 3 directions × 4 SL types = 12 combos per symbol.
"""
import json
import sys
import numpy as np
...
RESULTS_DIR = Path(r"C:\Users\danyw\Documents\Git\DanywayGit\trading-strategies-research\results\VP1\stage1")
...
# VP1 sl_mode semantics:
#   embedded      — POC as stop; TP1 at VA × tp1_mult, TP2 at VA × tp2_mult (partial exits).
#                   Optimises tp1_mult and tp2_mult.
#   fixed_pct     — Fixed-% SL/TP overrides POC stop; partial TP exits suppressed in next().
#                   Optimises stop_loss_pct and take_profit_pct.
#   fixed_signal  — Fixed-% SL/TP; VP1 partial TP exits remain active.
#                   Optimises stop_loss_pct and take_profit_pct.
#   atr           — BaseStrategy ATR stop + R:R TP replaces POC stop; partial TPs suppressed.
...
STRATEGY_CLASS = STRATEGY_REGISTRY["vp1_volume_profile_breakout"]
