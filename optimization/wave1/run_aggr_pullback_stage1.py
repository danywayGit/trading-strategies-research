#!/usr/bin/env python3
"""
AGGR_PULLBACK Stage 1 optimization across all available symbols.
...
# AGGR_PULLBACK sl_mode semantics:
#   embedded      — Swing low/high + ATR × stop_mult as SL; TP = stop_dist × rr_ratio.
#                   Optimises stop_mult and rr_ratio.
#   fixed_pct     — Fixed-% SL/TP overrides swing stop; no extra exit in next().
#                   Optimises stop_loss_pct and take_profit_pct.
#   fixed_signal  — Same as fixed_pct (AGGR_PULLBACK has no indicator-based trailing exit).
#   atr           — BaseStrategy ATR stop + R:R TP replaces swing stop.
...
STRATEGY_CLASS = STRATEGY_REGISTRY["aggr_pullback"]
