#!/usr/bin/env python3
"""
VP1 Stage 1 optimization — vectorbt v2 (PARALLEL).
1H volume profile breakout. POC approximated as rolling VWAP; VAH/VAL via
normal-distribution z-score from value_area_pct. 108 outer combos.
Approximation: partial TP at tp1_mult collapsed into single TP at tp2_mult.
"""
import sys
import os
...
def main():
    parser = argparse.ArgumentParser(description="VP1 Stage 1 v2 parallel optimization")
    ...
    print(f"VP1 Stage 1 v2 — Parallel ({args.workers} workers)")
