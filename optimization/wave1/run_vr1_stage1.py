#!/usr/bin/env python3
"""
VR1 Stage 1 optimization across all available symbols.
...
# VR1 sl_mode semantics:
#   embedded      — Band-width-based SL; TP = VWAP (mean reversion target); max_hold gated.
#                   Optimises band_mult, RSI thresholds, exhaustion filter.
#   fixed_pct     — Fixed-% SL/TP overrides band stop; max_hold exit suppressed.
#                   Optimises stop_loss_pct and take_profit_pct.
#   fixed_signal  — Fixed-% SL/TP; max_hold exit remains active.
#                   Optimises stop_loss_pct and take_profit_pct.
#   atr           — BaseStrategy ATR stop + R:R TP replaces band stop; max_hold suppressed.
...
STRATEGY_CLASS = STRATEGY_REGISTRY["vr1_vwap_mean_reversion"]
