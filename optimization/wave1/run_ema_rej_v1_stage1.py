#!/usr/bin/env python3
"""
EMA_REJ_V1 Stage 1 optimization across all available symbols.
...
# sl_mode framework: embedded=strategy ATR stop, fixed_pct=% stop, fixed_signal=% stop+signal exits, atr=BaseStrategy ATR stop
GRIDS = {
    "embedded": {
        "sl_mode": ["embedded"],
...
STRATEGY_CLASS = STRATEGY_REGISTRY["ema_rejection_v1"]
