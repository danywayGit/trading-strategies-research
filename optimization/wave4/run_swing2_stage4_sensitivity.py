#!/usr/bin/env python3
"""
SWING2 Stage 4 — parameter sensitivity analysis (PARALLEL).
...
Usage:
    python run_swing2_stage4_sensitivity.py
    python run_swing2_stage4_sensitivity.py --workers 8
    python run_swing2_stage4_sensitivity.py --skip-download
"""
import sys
import os
import argparse
...
def main():
    parser = argparse.ArgumentParser(
        description="SWING2 Stage 4 — parameter sensitivity (15m, 1h, 12h off-TFs)")
