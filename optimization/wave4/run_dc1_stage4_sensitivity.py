#!/usr/bin/env python3
"""
DC1 Stage 4 — parameter sensitivity analysis (PARALLEL).
...
Usage:
    python run_dc1_stage4_sensitivity.py
    python run_dc1_stage4_sensitivity.py --workers 8
    python run_dc1_stage4_sensitivity.py --skip-download
"""
import sys
import os
import argparse
...
def main():
    parser = argparse.ArgumentParser(
        description="DC1 Stage 4 — parameter sensitivity (15m, 1h, 12h off-TFs)")
