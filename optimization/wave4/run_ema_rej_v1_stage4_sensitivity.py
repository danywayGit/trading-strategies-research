#!/usr/bin/env python3
"""
EMA_REJ_V1 Stage 4 — parameter sensitivity analysis (PARALLEL).
...
Usage:
    python run_ema_rej_v1_stage4_sensitivity.py
    python run_ema_rej_v1_stage4_sensitivity.py --workers 8
    python run_ema_rej_v1_stage4_sensitivity.py --skip-download
"""
import sys
import os
import argparse
...
def main():
    parser = argparse.ArgumentParser(
        description="EMA_REJ_V1 Stage 4 — parameter sensitivity (15m, 4h, 12h off-TFs)")
