#!/usr/bin/env python3
"""
AGGR_PULLBACK Stage 4 — parameter sensitivity analysis (PARALLEL).
...
Usage:
    python run_aggr_pullback_stage4_sensitivity.py
    python run_aggr_pullback_stage4_sensitivity.py --workers 8
    python run_aggr_pullback_stage4_sensitivity.py --skip-download
"""
import sys
import os
import argparse
...
def main():
    parser = argparse.ArgumentParser(
        description="AGGR_PULLBACK Stage 4 — parameter sensitivity (15m, 1h, 12h off-TFs)")
