#!/usr/bin/env python3
"""
DC1 Stage 2 optimization — off-TF expansion (PARALLEL).

Runs full param-grid re-optimization on the 3 off-timeframes (15m, 1h, 12h)
for all DC1 Stage 1 combos with OOS Sharpe >= 0.5.

Usage:
    python run_dc1_stage2_parallel_v2.py
    python run_dc1_stage2_parallel_v2.py --workers 8
    python run_dc1_stage2_parallel_v2.py --skip-download
"""
import sys
import os
import argparse
...
def main():
    parser = argparse.ArgumentParser(
        description="DC1 Stage 2 — off-TF expansion (15m, 1h, 12h)")
