#!/usr/bin/env python3
"""
SWING4 Stage 3 optimization — DOW filter (PARALLEL).
...
Usage:
    python run_swing4_stage3_parallel_v2.py
    python run_swing4_stage3_parallel_v2.py --workers 8
    python run_swing4_stage3_parallel_v2.py --skip-download
"""
import sys
import os
import argparse
...
def main():
    parser = argparse.ArgumentParser(
        description="SWING4 Stage 3 — DOW filter (15m, 1h, 12h off-TFs)")
